...
// normal single-expiration watches and the curated leaderboard list are
// never evicted) until there's room.
const MAX_TOTAL_CONTRACTS = 900;
...
function createTradierHub({ token, onFlow, flowBuffer, onFlowEvent }) {
  let socket = null;
  let sessionId = null;
